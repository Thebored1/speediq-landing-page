...
export function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-black border-b border-neutral-800 h-12 flex items-center justify-between divide-x divide-neutral-800 font-mono">
      ...
      <div className="flex h-full items-center divide-x divide-neutral-800">
        <Link href="/" className="flex h-full items-center gap-2 group px-6 hover:bg-neutral-900 transition-colors">
          ...
          <span className="text-white font-semibold tracking-tight hidden sm:block">App</span>
        </Link>
      ...
      <div className="flex h-full items-center divide-x divide-neutral-800">
        <div className="hidden lg:flex h-full items-center divide-x divide-neutral-800">
          ...
          <Link 
            href="#" 
            className="flex h-full items-center px-6 text-sm font-medium bg-white text-black hover:bg-neutral-200 transition-colors gap-2 group"
          >
            Contact us
