...
export function ActionDropdownLight() {
  return (
    <div className="relative group h-full flex items-center">
      <button className="flex h-full items-center px-6 gap-2 bg-transparent text-black hover:bg-neutral-100 transition-colors text-sm font-medium cursor-default">
        Start today
      ...
      <div className="absolute right-0 top-full pt-2 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-out z-50">
        <div className="w-48 bg-white border border-neutral-200 rounded-sm shadow-2xl overflow-hidden">
          <div className="flex flex-col p-1.5 relative">
            <Link 
              href="#" 
              className="relative z-10 px-4 py-2.5 text-sm font-medium text-neutral-700 hover:text-black hover:bg-neutral-100 rounded-sm transition-all duration-200 ease-in-out group/item"
            >
