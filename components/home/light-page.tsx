...
function Num({ children }: { children: string }) {
  return (
    <span style={{
      fontFamily: '"Courier New", Courier, monospace',
      fontSize: 10, color: "rgba(0,0,0,0.2)", letterSpacing: "0.06em",
    }}>
      {children}
    </span>
  )
...
function CornerMarks() {
  const base: CSSProperties = {
    ...
    color: "rgba(0,0,0,0.18)", userSelect: "none", zIndex: 2,
  }
  return (
    <>
  ...
  return (
    <svg viewBox="0 0 300 300" width="100%" height="100%" fill="none" stroke="rgba(0,0,0,0.4)" strokeWidth="1.5">
      ...
      <g transform="translate(0, 30)">
        {/* Tray bottom */}
        <path d="M 150 200 L 250 150 L 150 100 L 50 150 Z" fill="rgba(0,0,0,0.02)" filter="url(#shadow-1)" />
        {/* Tray walls */}
        <path d="M 50 150 L 150 200 L 150 220 L 50 170 Z" fill="rgba(0,0,0,0.05)" />
  ...
  return (
    <svg viewBox="0 0 300 300" width="100%" height="100%" fill="none" stroke="rgba(0,0,0,0.4)" strokeWidth="1.5" strokeLinejoin="round">
      ...
      <g transform="translate(0, 50)">
        <path d="M 150 220 L 250 170 L 150 120 L 50 170 Z" fill="rgba(0,0,0,0.02)" filter="url(#shadow-3)" />
      ...
      <div className="gf" style={{ fontFamily: "var(--font-sans)", background: "#ffffff" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              ...
              <div style={{
                ...
                background: "linear-gradient(to right, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.7) 45%, rgba(255,255,255,0) 100%)", pointerEvents: "none", zIndex: 1,
              }} />
              ...
              <div style={{
                ...
                color: "rgba(0,0,0,0.18)", textTransform: "uppercase" as const,
                pointerEvents: "none",
              }}>
                <span>SCROLL</span>
            ...
            <div style={{ borderBottom: "1px solid rgba(0,0,0,0.08)", background: "#ffffff" }}>
              <div style={{
                  margin: "0 40px",
                  position: "relative",
                  padding: "18px 40px",
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    color: "rgba(0,0,0,0.42)", margin: 0, maxWidth: 460,
                  }}>
                ...
                <div key={i} style={{
                  ...
                  <div style={{ marginBottom: 40 }}>
                    ...
                    <p style={{
                      ...
                      color: "rgba(0,0,0,0.42)", margin: 0, maxWidth: 400,
                    }}>{f.body}</p>
                  </div>
        ...
        <div style={{ background: "#ffffff", borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
          <div style={{ margin: "0 40px", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 3fr 3fr 3fr 1fr", borderTop: "1px solid rgba(0,0,0,0.08)" }}>
              <div />
              {[
                {
            ...
            <div style={{ padding: "80px 0", maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
              ...
              <div style={{ maxWidth: 800 }}>
                ...
                <p style={{
                  ...
                  color: "rgba(0,0,0,0.6)", margin: "0 0 48px", maxWidth: 500,
                }}>
        ...
        <footer style={{ background: "#ffffff" }}>
          <div style={{ margin: "0 40px", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}>
            <div style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 0 40px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid rgba(0,0,0,0.08)", paddingTop: 32 }}>
                <div style={{ fontFamily: "var(--font-sans)", fontSize: 12, color: "rgba(0,0,0,0.4)" }}>
                  © 2026 SpeedIQ. All rights reserved.
                </div>
                <div style={{ display: "flex", gap: 32 }}>
                  {["Privacy Policy", "Terms of Service", "Security"].map(link => (
                    <a key={link} href="#" style={{ fontFamily: "var(--font-sans)", fontSize: 12, color: "rgba(0,0,0,0.5)", textDecoration: "none" }}>{link}</a>
                  ))}
                </div>
              </div>
            </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#fafafa" }}>
         ...
         <div style={{ height: "60px", borderBottom: "1px solid rgba(0,0,0,0.05)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
               <div style={{ fontSize: 13, color: "rgba(0,0,0,0.4)" }}>Updated 2 min ago</div>
               <div style={{ fontSize: 13, color: "rgba(0,0,0,0.8)", display: "flex", alignItems: "center", gap: 6, background: "transparent", cursor: "pointer" }}>
               ...
               <div style={{ display: "flex", gap: 20 }}>
                  ...
                  <div style={{ flex: 1.5, border: "1px solid rgba(0,0,0,0.08)", background: "#f5f5f5", borderRadius: 12, padding: "24px" }}>
                     ...
                     <div style={{ height: 24, borderRadius: 12, display: "flex", overflow: "hidden", gap: 2 }}>
                        <div style={{ flex: 5.5, background: "repeating-linear-gradient(45deg, rgba(0,0,0,0.3), rgba(0,0,0,0.3) 2px, transparent 2px, transparent 4px)" }} />
                        <div style={{ flex: 3.5, background: "repeating-linear-gradient(45deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2) 2px, transparent 2px, transparent 4px)" }} />
                        <div style={{ flex: 1, background: "repeating-linear-gradient(45deg, rgba(0,0,0,0.1), rgba(0,0,0,0.1) 2px, transparent 2px, transparent 4px)" }} />
                     </div>
                  </div>
               </div>
