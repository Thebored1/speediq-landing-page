...
const SCENARIOS = [
  { n: "01", title: "Admissions & Enquiry Follow-Up", body: "When a prospective student enquires, trigger an instant WhatsApp reply with a brochure link and counsellor contact. Sequence follow-up emails over 7 days with campus tour invites, fee details, and scholarship info.", channels: ["WhatsApp", "Email"], stat: "2.8x admission conversion vs email-only" },
  { n: "02", title: "Fee Payment Reminders", body: "Automate term-fee due-date reminders via WhatsApp and SMS. Escalate to the parent's number if the student hasn't responded in 48 hours. Reduce late fees and admin overhead dramatically.", channels: ["WhatsApp", "SMS"], stat: "Fee collection on-time rate up 44%" },
  { n: "03", title: "Exam & Event Notifications", body: "Broadcast exam timetables, result announcements, and event invitations instantly to all enrolled students via WhatsApp. With 95%+ open rates, critical updates are never missed.", channels: ["WhatsApp", "SMS"], stat: "95.4% open rate vs 22% for email newsletters" },
  { n: "04", title: "Student Re-Engagement", body: "Identify students who have stopped logging into the LMS or missed consecutive classes. Auto-trigger a caring WhatsApp message from their tutor, followed by an SMS with a support resources link.", channels: ["WhatsApp", "SMS"], stat: "Dropout intervention success rate of 31%" },
]

const OTHERS = [["E-commerce", "/use-cases/ecommerce"], ["SaaS", "/use-cases/saas"], ["Agencies", "/use-cases/agency"], ["Real Estate", "/use-cases/real-estate"], ["Fintech", "/use-cases/fintech"]]
          ...
          <div style={{ borderBottom: `1px solid ${T.line}` }}>
            <div style={{ margin: "0 40px", borderLeft: `1px solid ${T.line}`, borderRight: `1px solid ${T.line}`, padding: "80px 56px 56px" }}>
              <div style={{ display: "flex", gap: 12, marginBottom: 20, flexWrap: "wrap" as const }}>
                <Tag>Use Cases</Tag>
                <span style={{ fontSize: 10, color: T.num, fontFamily: "'Courier New', monospace", letterSpacing: "0.1em", textTransform: "uppercase" as const, display: "flex", alignItems: "center" }}>/ Education</span>
              </div>
              <h1 style={{ fontSize: "clamp(28px, 4.5vw, 56px)", fontWeight: 500, letterSpacing: "-0.03em", color: T.fg, margin: "0 0 20px", lineHeight: 1.05, maxWidth: 700 }}>Engage students, collect fees on time.</h1>
              <p style={{ fontSize: 16, color: T.fg4, maxWidth: 560, lineHeight: 1.7, margin: "0 0 36px" }}>SpeedIQ helps schools, colleges, and ed-tech platforms communicate with students and parents via WhatsApp, send automated fee reminders, and broadcast critical academic updates.</p>
